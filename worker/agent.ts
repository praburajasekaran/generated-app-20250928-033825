...
export class ChatAgent extends Agent<Env, ChatState> {
  ...
  async onStart(): Promise<void> {
    const systemPrompt = 'You are Zenith, an expert assistant for Obsidian, a powerful knowledge base on top of a local folder of plain text Markdown files. Your role is to help users manage their notes, create content, and query their knowledge base. When referencing other notes, use the Markdown syntax [[Note Title]]. Be concise and helpful.';
